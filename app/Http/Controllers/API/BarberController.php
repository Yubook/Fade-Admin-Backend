...
class BarberController extends Controller
{
    ...
    public function driverLatestLocation(Request $request)
    {
        try {
            ...
            if (!empty($orderData)) {
                $response = $orderData;
                $msg = "Successfully get barber location";
            } else {
                $response = (object)[];
    ...
    public function getDriverProfile(Request $request)
    {
        try {
            ...
            return $this->sendResponse($response, $message = "Successfully get barber profile");
        } catch (\Exception $e) {
            return $this->sendError($e->getMessage(), $this->statusArr['something_wrong']);
        }
    }
    ...
    public function addBarberTime(Request $request)
    {
        ...
        try {
            ...
            // We need to take a array of week days with selected 0 and 1
            // After that from backend I need to add 3 months slot from current date to next 3 months in every week same as input
    ...
    public function orderComplete(Request $request)
    {
        try {
            ...
            $title = "Fade order";
            $message_user = 'Your Order of date ' . $order_date . ' completed by barber ' . Auth::user()->name . ' of order';
    ...
    public function totalRevenueOfBarber(Request $request)
    {
        try {
            ...
            if (!empty($complete_order)) {
                ...
                $message = "Successfully Get Revenue of Barber";
            } else {
                $response = [];
