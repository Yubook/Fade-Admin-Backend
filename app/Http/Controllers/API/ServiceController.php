...
class ServiceController extends Controller
{
    public function addBarberService(Request $request)
    {
        try {
            ...
            return $this->sendResponse($response = [], "Barber Service Add Successfully");
        } catch (\Exception $e) {
    ...
    public function getBarberService()
    {
        try {
            ...
            return $this->sendResponse($response = $getServices, "Barber services get successfully");
        } catch (\Exception $e) {
            return $this->sendError($e->getMessage(), $this->statusArr['something_wrong']);
        }
    }
    ...
    public function deleteBarberService(Request $request)
    {
        ...
        try {
            ...
            if ($check > 0) {
                ...
                $msg = "Barber Service delete Successfully";
                ...
                $response = [];
                $msg = "You are not authorized barber";
            }
