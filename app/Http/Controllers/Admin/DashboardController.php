...
class DashboardController extends Controller
{
    ...
    public function ajaxOrderModal(Request $request)
    {
        try {
            ...
            $html .= '<p class="mb-2">Barber Name: <span class="text-secondary">' . $getOrder->barber->name . '</span></p>';
