        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Add New Barber</h4>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Basic Barber Information</h4>
                                ...
                                <form action="{{ route('barbers.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label>Barber Address line 1 *</label>
                                            ...
                                            <div class="form-group">
                                                <label>Barber Address line 2</label>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <label>Barber Document Name *</label>
