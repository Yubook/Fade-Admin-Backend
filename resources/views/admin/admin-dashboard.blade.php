                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-3">
                                    ...
                                    <p class="text-light">Fade Dashboard</p>
                                </div>
                            </div>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div id="barber{{$barber['id'] ?? ''}}">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <h3>Barber {{$key ?? ''}}</h3>
                                                    <h4 class="card-title mb-4">Mobile Saloon</h4>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-7">
                                                    ...
                                                    @endif
                                                    <h4 class="card-title">Barber Name : {{$barber['name'] ?? ''}}</h4>
                                                    <h4 class="card-title">Barber Mobile : {{$barber['mobile'] ?? ''}}</h4>
                                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mini-stats-wid">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body">
                                            <p class="text-muted font-weight-medium">Barbers</p>
                        ...
                        <div class="col-md-4">
                            <div class="card mini-stats-wid">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body">
                                            <p class="text-muted font-weight-medium">Barber Revenue</p>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between">
                                <h4 class="card-title mb-4">New Barber Request</h4>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between">
                                <h4 class="card-title mb-4">Rejected Barber Request</h4>
                            </div>
                            <div class="table-responsive">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-between">
                                ...
                                <div class="btn-group btn-group-sm tab card-title mb-4" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" onclick="click_table(this,2)" class="btn btn-outline-dark tablinks">Barber</button>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.taskActionBtnBarber,.taskActionBtnBarberOld', function(e) {
        ...
        if (type == 1) {
            var title = "Are you sure approve this barber?";
        } else {
            var title = "Are you sure reject this barber?";
        }
        Swal.fire({
            title: title,
            icon: "warning",
